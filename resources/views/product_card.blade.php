<div class="card" style="width: 300px; margin: 20px">
	<button onclick="totalCalculation('{{$product->product_name}}', {{$product->product_price}})">
		<img class="card-img-top img-fluid" src="{{ asset($product->product_path_img) }}" alt="Card image cap">
